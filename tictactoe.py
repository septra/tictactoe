...
if __name__ == '__main__':
    ...
    print("Enter position to play in [r,c] format\n" +
          "Ex:\t>> 1,2\n")

    game = Game()

    print(game)
    print("It's %s's turn to begin" % game.turn)
    ...
    while ongoingGame:
        ...
        row, col = int(playerInput[0]), int(playerInput[1])
        ongoingGame = game.play(row, col)
        print(game)
        print("")
